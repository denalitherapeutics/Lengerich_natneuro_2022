...
# FIXME: This is a non-portable path. Perhaps you can use a relative path?
...
# FIXME: global options are better placed at the start of the document
...
write.csv(markers,
          file = here("inst", "extdata", "Study1_cluster_markers.csv")
          )
```
...
markers <-
  read.csv(
    here("inst", "extdata", "Study1_cluster_markers.csv"),
    row.names = 1,
    header = TRUE
  )
...
# FIXME: can you use a relative file path?
